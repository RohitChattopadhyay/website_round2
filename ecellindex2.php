...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item" id="toptwo" style="color:white">
      <img src="https://www.pixelstalk.net/wp-content/uploads/2016/03/goodwp.com_16580.jpg" alt="Chicago" style="width:100%;">
                  ...
                  <div class="header-text" style="color:white">
                      <div class="col-md-12 text-center">
                          <h2>
                            <span>Welcome to <strong>JU E-Cell</strong></span>
                          </h2>
                          <br>
                          <h3>
    ...
    <div class="item" id="topone" style="color:white">
      <img src="https://idesktopwallpaper.com/wp-content/uploads/2017/02/wonder-woman-wallpaper-cell-phone.jpg"  style="width:100%;">
...
<div class='paget vision' style="text-align:center">
  ...
  <div id="vision" style="text-align:center">
    <h2>
VISION
</h2>
<br>
<p>
Our vision is that entrepreneurship is the next big thing that our country needs to exploit full <br>
potential of the innovative youth of the country, promote the economy and raise the overall quality of <br>
life in our country. At E-Cell, we try to realise our vision by developing the entrepreneurial environment by<br>
 providing easy and effective interaction of the student body, experienced professionals, successful entrepreneurs,<br>
  investors, venture capitalists and corporates.
</p>
</div>
  </div>
    ...
    <div class='sectiont featuret-1'>
        ...
        <div>
          <p style="text-align: center"> Lorem Ipsum  dolasdsa asdasd <br>adasd asd as dasd <br>asdsadsa dsadsd</p>
        </div>
    </div>
    ...
    <div>
        ...
        <div>
          <p style="text-align: center"> Lorem Ipsum  dolasdsa asdasd<br> sadasd asd as dasd<br> asdsadsa dsadsd</p>
        </div>
      </div>
...
<div class="countersz" style="color: white">
 <div><span id= "counter" class="counter-value" data-count="500" style="font-size: 35px">0</span>
    <h3>Members</h3></div>
    <div>  <span id="counter"  class="counter-value" data-count="50" style="font-size: 45px">0</span><h3>Coordinators</h3> </div>
   <div> <span id="counter" class="counter-value" data-count="75" style="font-size: 45px">0</span><h3>Campus<br> Ambassadors</h3> </div>
...
<div>
<img data-u="image" src="http://via.placeholder.com/350x122.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x122jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x123.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x123jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x124.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x124jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x125.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x125jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x126.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x126jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x127.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x127jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x121.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x121jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x128.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x128jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x129.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x129jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x1030.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x130jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x131.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x131jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
<div>
<img data-u="image" src="http://via.placeholder.com/350x132.jpg" />
<div data-u="thumb">
<img data-u="thumb" src="http://via.placeholder.com/350x132jpg" />
<div class="ti">Tiltle of image</div>
</div>
</div>
</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="carousel slide" data-ride="carousel" id="quote-carousel">
				...
				<div class="carousel-inner text-center" id="testi">
						...
						<blockquote>
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2">
									...
									<small>ahsss</br>CSE UG-II,JU</small>
               ...
               <div  class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <form>
                        ...
                        <select class="form-control" id="co_dept" name="dept" placeholder="Department" required>
                        ...
                        <br>
                        <input type="submit" value="Apply" id="applicatioss">
                     </form>
                  </div>
               </div>
            </div>
               ...
               <div  class="modal-content">
                  ...
                  <div class="modal-body">
                     ...
                     <form>
                        <input type="text" id="name" name="name" placeholder="Name">
                        <input type="text" id="email" name="email" placeholder="Email">
                        <input type="text" id="college" name="college" placeholder="College/University">											
                        <select class="form-control" id="co_dept" name="dept" placeholder="Department" required>
                           <option value="" selected disabled hidden>Department</option>
                           <optgroup label="Engineering &amp; Technology">
                              <option value="Architecture">Architecture</option>
                        ...
                        <input type="number" id="pass" name="pass" placeholder="Pass year">
                        <input type="number" id="phone" name="phone" placeholder="Phone">
                        <br>
